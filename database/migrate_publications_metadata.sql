-- Alter existing publications table to add new columns
ALTER TABLE publications ADD volume VARCHAR(50);
ALTER TABLE publications ADD issue VARCHAR(50);
ALTER TABLE publications ADD pages VARCHAR(50);
ALTER TABLE publications ADD published_date DATE;
ALTER TABLE publications ADD abstract TEXT;
ALTER TABLE publications ADD keywords TEXT;
ALTER TABLE publications ADD journal_url VARCHAR(255);
ALTER TABLE publications ADD featured_image VARCHAR(255);
ALTER TABLE publications ADD issn_e VARCHAR(20);
ALTER TABLE publications ADD issn_p VARCHAR(20);
ALTER TABLE publications ADD publication_frequency VARCHAR(100);
ALTER TABLE publications ADD peer_review_type VARCHAR(100);
ALTER TABLE publications ADD publication_fee VARCHAR(100);
ALTER TABLE publications ADD abbreviation VARCHAR(50);
